...
STOCK_EXCHANGES: Set[str] = {
    ...
    "nse", "bse",                       # India — National Stock Exchange / Bombay Stock Exchange
}
...
EXCHANGE_SCREENER = {
    ...
    # India — National Stock Exchange / Bombay Stock Exchange
    "nse": "india",
    "bse": "india",
}
...
_YAHOO_SYMBOL_ALIASES: dict = {
    ...
    "TWSE:TAIEX": "^TWII",
    "TWSE:IX0001": "^TWII",
    # India indices — bare/common names -> Yahoo Finance ticker.
    "NIFTY": "^NSEI",
    "NIFTY50": "^NSEI",
    "NIFTY 50": "^NSEI",
    "NSE:NIFTY": "^NSEI",
...
_TRADINGVIEW_SYMBOL_ALIASES: dict = {
    ...
    "XAUUSD": "TVC:GOLD",
    "XAGUSD": "TVC:SILVER",
    # India indices — bare/common names -> TradingView ticker (verified live
    # against the `india` scanner market with type=index; NSE and BSE only,
    # no ":" needed since these ARE the canonical prefixed symbols).
    "NIFTY": "NSE:NIFTY",
    "NIFTY50": "NSE:NIFTY",
    "^NSEI": "NSE:NIFTY",
